...
class YuntxSmsController extends AddonController
{
    ...
    public function sendSms($to, $data, $tempId)
    {
        ...
        // 'aaf98f894979d7be01497ea4bd2b03ad';

        $accountToken = $config['account_token'];
        // '367b3424e7c946c7ad7f63327e2da04e';

        $appId = $config['app_id'];
        // '8a216da85635b77e015648dba5dc0995';
        ...
        if ($result->statusCode != 0) {
            ...
            writeLog("给手机号{$to}发送内容为" . var_export($data, true) . "的，模板为{$tempId}的短信失败, 失败原因：（{$result->statusCode}| {$result->statusMsg}）", 'Yuntx');
        } else {
