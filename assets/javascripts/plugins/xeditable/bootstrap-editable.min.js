        ...
        makeArray: function(data) {
            ...
            if($.isArray(data)) { //array
                /* 
                 ...
                 Caclulates count of keys in item and business in obj.
                 */
        ...
        highlight: function(dt) {
            if(!dt.isValid()) {
                if(this.options.errorClass) {
                    ...
                    //business original border color
                    if(!this.borderColor) {
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         Overwrite typeahead's render method to business objects.
         There are a lot of disscussion in bootstrap repo on this point and still no result.
         See https://github.com/twitter/bootstrap/issues/5967 

         This function just business item via jQuery data() method instead of attr('data-value')
         */
