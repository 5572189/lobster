...
// 		//增加语言版本的默认查询条件---start
// 		$tableName = $this->getTableName();
// 		if (in_array($tableName, ['oc_shoppingmall_wineclass','oc_admin_user','oc_admin_access'])) {
// 			//;
// 		}
// 		elseif ($str = strrpos($tableName, 'as')) {
// 			$tableName = substr($tableName, $str + 3 , strlen($tableName) - $str);
// 		}
// 		elseif ($str = strrpos($tableName," ")){
// 			$tableName = substr($tableName, $str + 1 , strlen($tableName) - $str);
// 		}
// 		if (!isset($where['lang'])&&!isset($where[$tableName.'.lang'])&&!isset($where[$this->trueTableName.'.lang'])) {
// // 			if (cookie('lang')) {
// // 				$where[$tableName.'.lang'] = $where[$tableName.'.lang'] ? $where[$tableName.'.lang'] : cookie('lang');
// // 			}
// // 			else{
// 				$where[$tableName.'.lang'] = $where[$tableName.'.lang'] ? $where[$tableName.'.lang'] : "cn";
// // 			}
// 		}
// 		//----end
