...
//                 //如果在要报警的日志范围内
//                 if (in_array($level, ['EMERG', 'ALERT', 'CRIT', 'ERR', 'WARN', 'NOTIC'])) {
//                     if (false === stripos($message, 'Only variables should be passed by reference ') && false === stripos($message, 'should be compatible') && (false === stripos($message, 'Array to string conversion')) && false === stripos($message, '无法加载控制器:Undefined')) {
//                         ptrace("发生错误，错误等级{$level}");
//                         ptrace($message);
//                     }
//                 }
//             }
